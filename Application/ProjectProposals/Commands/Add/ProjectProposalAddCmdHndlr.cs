...
{
    public class ProjectProposalAddCmdHndlr : ICommandHandler<ProjectProposalAddCmd,bool>
    {
        ...
        public ProjectProposalAddCmdHndlr(IProjectProposalRepository projectProposalRepository, IUserRepository userRepository, IApprovalStatusRepository approvalStatusRepository, IProjectTypeRepository projectTypeRepository, IAreaRepository areaRepository)
        {
        ...
        public async Task<bool> Handle(ProjectProposalAddCmd command)
        {
            ...
            return await _projectProposalRepository.Add(dto);
