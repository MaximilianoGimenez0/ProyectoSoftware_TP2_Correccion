...
CREATE TABLE [User] (
    ...
    CONSTRAINT [FK_User_ApproverRole_Role] FOREIGN KEY ([Role]) REFERENCES [ApproverRole] ([Id])
);
...
CREATE TABLE [ProjectApprovalSteps] (
    ...
    [Status] int NOT NULL,
    [StepProjectProposalId] uniqueidentifier NOT NULL,
    [StepUserId] int NULL,
    ...
    CONSTRAINT [FK_ProjectApprovalSteps_ProjectProposals_StepProjectProposalId] FOREIGN KEY ([StepProjectProposalId]) REFERENCES [ProjectProposals] ([Id]) ON DELETE CASCADE,
...
CREATE INDEX [IX_ProjectApprovalSteps_StepProjectProposalId] ON [ProjectApprovalSteps] ([StepProjectProposalId]);
...
VALUES (N'20250422040602_first_setup', N'9.0.4');
