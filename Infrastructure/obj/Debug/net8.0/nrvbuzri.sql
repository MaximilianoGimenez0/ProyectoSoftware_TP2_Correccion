...
CREATE TABLE [ApprovalRule] (
    ...
    CONSTRAINT [FK_ApprovalRule_ApproverRole_ApprovalRuleApproverRoleId] FOREIGN KEY ([ApprovalRuleApproverRoleId]) REFERENCES [ApproverRole] ([Id]) ON DELETE RESTRICT,
    CONSTRAINT [FK_ApprovalRule_Area_ApprovalRuleAreaId] FOREIGN KEY ([ApprovalRuleAreaId]) REFERENCES [Area] ([Id]) ON DELETE RESTRICT,
    CONSTRAINT [FK_ApprovalRule_ProjectType_ApprovalRuleTypeId] FOREIGN KEY ([ApprovalRuleTypeId]) REFERENCES [ProjectType] ([Id]) ON DELETE RESTRICT
);
...
CREATE TABLE [ProjectProposals] (
    ...
    CONSTRAINT [FK_ProjectProposals_ApprovalStatus_ProjectProposalApprovalStatusId] FOREIGN KEY ([ProjectProposalApprovalStatusId]) REFERENCES [ApprovalStatus] ([Id]) ON DELETE RESTRICT,
    CONSTRAINT [FK_ProjectProposals_Area_ProjectProposalAreaId] FOREIGN KEY ([ProjectProposalAreaId]) REFERENCES [Area] ([Id]) ON DELETE RESTRICT,
    CONSTRAINT [FK_ProjectProposals_ProjectType_ProjectProposalTypeId] FOREIGN KEY ([ProjectProposalTypeId]) REFERENCES [ProjectType] ([Id]) ON DELETE RESTRICT,
    CONSTRAINT [FK_ProjectProposals_User_ProjectProposalUserId] FOREIGN KEY ([ProjectProposalUserId]) REFERENCES [User] ([Id]) ON DELETE RESTRICT
);
...
CREATE TABLE [ProjectApprovalSteps] (
    ...
    CONSTRAINT [FK_ProjectApprovalSteps_ApprovalStatus_StepApprovalStatusId] FOREIGN KEY ([StepApprovalStatusId]) REFERENCES [ApprovalStatus] ([Id]) ON DELETE RESTRICT,
    CONSTRAINT [FK_ProjectApprovalSteps_ApproverRole_ApproverRoleId] FOREIGN KEY ([ApproverRoleId]) REFERENCES [ApproverRole] ([Id]) ON DELETE RESTRICT,
    CONSTRAINT [FK_ProjectApprovalSteps_ProjectProposals_ProjectProposalId] FOREIGN KEY ([ProjectProposalId]) REFERENCES [ProjectProposals] ([Id]) ON DELETE RESTRICT,
    CONSTRAINT [FK_ProjectApprovalSteps_User_StepUserId] FOREIGN KEY ([StepUserId]) REFERENCES [User] ([Id]) ON DELETE RESTRICT
);
